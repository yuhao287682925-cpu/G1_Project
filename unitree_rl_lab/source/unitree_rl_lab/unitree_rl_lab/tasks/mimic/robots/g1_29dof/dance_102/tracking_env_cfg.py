...
class RobotSceneCfg(InteractiveSceneCfg):
    ...
    terrain = TerrainImporterCfg(
        ...
        terrain_generator=terrain_gen.ROUGH_TERRAINS_CFG,
...
class RewardsCfg:
    ...
    # AMP style reward (disabled by default; trainer should set env.amp_style_scale and attach discriminator)
    amp_style = RewTerm(
        func=mdp.amp_style_reward_term,
        weight=1.0,
