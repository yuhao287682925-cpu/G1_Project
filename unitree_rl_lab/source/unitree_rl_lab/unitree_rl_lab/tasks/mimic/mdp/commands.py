...
class MotionCommand(CommandTerm):
    ...
    def __init__(self, cfg: MotionCommandCfg, env: ManagerBasedRLEnv):
        ...
        # Compute a sensible fallback fps from environment sim settings
        try:
            fallback_fps = 1.0 / (env.cfg.decimation * env.cfg.sim.dt)
        except Exception:
            fallback_fps = None
        self.motion = MotionLoader(self.cfg.motion_file, self.body_indexes, device=self.device, motion_fps=fallback_fps)
